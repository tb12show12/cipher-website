...
async function loadTripData(tripId) {
    try {
        ...
        // Update form fields
        document.getElementById('mainTitle').textContent = tripData.title;
            ...
            processedPlaces
                ...
                .forEach(newPlace => {
                    placesData[newPlace.id] = {
                        id: newPlace.id,
                        ...placeDetails.find(pd => pd.gpid === newPlace.placeId)
                    };
                });
